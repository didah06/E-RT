                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    <?php foreach ($vendor as $table) : ?>
                                        <tr>
                                            <td class="text-center"> <input type="checkbox" class="delete-checkbox" data-id="<?= $table->id_vendor; ?>"></td>
...
<script>
    $(document).ready(function() {
        ...
        $('#delete-selected').on('click', function() {
            ...
            $.ajax({
                method: 'POST',
                url: "<?= base_url('vendor_delete'); ?>", // Send data as POST, not in the URL
                data: {
                    id_vendor: idsToDelete
                },
                error: function(xhr) {
