<section class="content">
    <div class="block-header">
        <div class="row">
            ...
            <div class="btn-user pt-3 pl-3">
                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#security-add"><i class="zmdi zmdi-plus-circle"></i>Tambah Security</a>
            </div>
        </div>
    </div>
    <div class="col-md-12">
                    ...
                    <table id="datatables" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            <?php foreach ($security as $table) : ?>
                                <tr>
                                    <td>
                                        <button class="btn btn-warning btn-icon hidden-sm-down float-right m-l-3 btn-edit" data-id="<?= $table->user_id; ?>" data-toggle="modal" data-target="#security-edit" type="button">
    ...
    <!-- security add -->
    <!-- modal -->
    <div class="modal fade" id="security-add" data-backdrop="false" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLongTitle">Tambah Security</h6>
                ...
                <div class="modal-body">
                    ...
                    <?= form_open(base_url('security'), ['class' => 'add-form']); ?>
                    <div class="row">
                        <div class="col-md-6">
    ...
    <!-- security Edit -->
    <!-- modal -->
    <div class="modal fade modal-update" id="security-edit" data-backdrop="false" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLongTitle">Edit Security</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="error-area"></div>
                    <?= form_open(base_url('security'), ['class' => 'update-form']); ?>
