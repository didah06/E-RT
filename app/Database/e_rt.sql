...
CREATE TABLE `tb_booking_transport`  (
  ...
  `jam_keberangkatan` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `ditolak_by` int(11) NULL DEFAULT NULL,
  `ditolak_nama` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ditolak_at` int(11) NULL DEFAULT NULL,
